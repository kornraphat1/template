<div id="content">
    ...
    <div class="content-main">
        ...
        <div class="box">
            ...
            if(!empty($movie['list'])){
                foreach ($movie['list'] as $key => $value) {
                ...
                <ul>
                    ...
                    <div class="topbar-filter">
                        ...
                        <div class="pagination2">
                            ...
                            <?= pagination($movie['page'], $movie['total_page']); ?>
                    ...
                    <div id="fix_footer2" style="width:100%; display:block;  overflow:hidden; line-height:0px;">
                        ...
                        <div style="display:inline-block; width:100%; text-align:center;">
                            ...
                            <div class="textwidget custom-html-widget">
                                ...
                                <center><a onclick="onClickAds(<?= $value['ads_id'] ?>, <?= $branch ?>)" href="<?=$value['ads_url']?>" target="_blank" rel="noopener"><img alt="<?= $value['ads_name'] ?>" title="<?= $value['ads_name'] ?>" src="<?php $path_ads . $value['ads_picture']; ?>" width="70%"></a></center>
