...
<head>
    <meta charset="utf-8" />
    <script src="<?php echo $document_root ?>assets/js/anime/jwplayer.js"></script>
    <script src="<?php echo $document_root ?>assets/js/anime/g23lrur.js"></script>
...
<body class="if-size">
    <div id="playervideo" style="display: none;">Anime Player</div>
