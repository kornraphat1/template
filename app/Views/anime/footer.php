      ...
      function goReport(id, branch,name,ep) {
            ...
            if (request != null && request != '') {
                jQuery.ajax({
                    ...
                    url: "<?php echo base_url()?>/anime/savereport/branch/" + branch + "/id/" + id + "/reason/" + request + "/name/" + name + "/ep/" + ep,
                    type: 'GET',
                    crossDomain: true,
                    cache: false,
        ...
        jQuery("#formsearch").submit(function(event) {
            ...
            if (jQuery("#search").val()) {
                ...
                var url = "<?= base_url('anime/search') ?>" + '/' + jQuery("#search").val();
        ...
        function countView(id) {
            ...
            var url = base_url + "/anime/countview/" + id;
            // alert(url);
            jQuery.ajax({
