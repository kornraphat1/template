    ...
    <script>
        function goReport(id, branch, name) {
            ...
            if (request != null && request != '') {
                jQuery.ajax({
                    ...
                    url: "<?php echo base_url()?>/av/savereport/branch/" + branch + "/id/" + id + "/reason/" + request + "/name/" + name,
                    type: 'GET',
                    crossDomain: true,
                    cache: false,
        ...
        function request_movie(branch) {
            ...
            if (movie != null) {
                ...
                jQuery.ajax({
                    ...
                    url: "/av/saverequest/branch/" + branch + "/movie/" + movie,
        ...
        function countView(id) {
            ...
            var url = base_url + "/av/countview/" + id;
            // alert(url);
            jQuery.ajax({
