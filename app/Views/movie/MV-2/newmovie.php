   ...
   <section class="sec_main sec_main-mobile">
       ...
       <div class="sec_main-cen">
                ...
                ?>
                   <div class="movie_box">
                       ...
                       <a href="<?php echo  $urlvideo; ?>">
                           <img width="300" height="452" src="<?php echo $value['movie_picture']; ?>" class="attachment-mediam size-mediam wp-post-image" alt="" sizes="(max-width: 300px) 100vw, 300px" />
                           <h2>
                               <p>
                                   <?php echo $moviename; ?>
                               </p>
           ...
           <!-- Pagination -->
           <div class="box" style="padding-top: 8rem;">
