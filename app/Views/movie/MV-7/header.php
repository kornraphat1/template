...
<head>
  ...
  <!-- TAG og facebook -->
	...
	<meta property="og:image" content="<?php echo $setting['setting_logo']; ?>" />
	...
	<meta name="twitter:image" content="<?php echo $setting['setting_logo']; ?>" />
  ...
  <script src="movie/js/defualt.js"></script>
