<div class="hero common-hero">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="hero-ct">
                    <h1> คุณกำลังค้นหา '<?=$keyword_string?>'</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row ipad-width">
            ...
            <div class="col-md-4 ">
                ...
                <?php //echo "<pre>"; print_r($path_imgads);
            ...
            <div class="col-md-8 col-xs-12 manga-item-list">
                ...
                <div class="title-hd">
                    <!-- <h2>คุณกำลังค้นหา '<?php echo $keyword_string?>'</h2> -->
                </div>
                    ...
                    ?>
                        ...
                        <div class="movie-item-style-2 movie-item-style-1">
                            ...
                            <div class="mv-item-infor">
                                ...
                                <p class="rate"><i class="ion-android-star"></i><span><?php echo $value['movie_ratescore']; ?></span> <span style="float: right;"><i class="fa fa-eye" aria-hidden="true"></i> <?php  if(empty($value['movie_view'])){ echo "0";}else{ echo $value['movie_view'];} ?></span> </p>
                            </div>
            ...
            <?php 
                    ...
                    echo "<div style='font-size: 16px; color: #fff; padding: 40px;'><center>ไม่พบสิ่งที่คุณกำลังค้นหา</canter></div>"; }
            ?>
            </div>
