<head>
    ...
    <!-- CSS files -->
    <link rel="stylesheet" href='<?php echo base_url("/assets/css/custom.css?v=4"); ?>' />
    <link rel="stylesheet" href='<?php echo base_url("/assets/css/style.css?v=2"); ?>' />
    <link rel="stylesheet" href='<?php echo base_url("/assets/css/plugins.css?v=2"); ?>' />
    <link rel="stylesheet" href='<?php echo base_url("/assets/css/animate.css?v=1"); ?>' />
    <link rel="stylesheet" href='<?php echo base_url("/assets/css/font-awesome.min.css?v=1"); ?>'>
...
<style>
    ...
    @media only screen and (min-width: 321px) and (max-device-width: 413px) {
        ...
        <div class="container">
            <nav class="navbar navbar-default">
                ...
                <div class="navbar-header logo">
                    ...
                    <?php //echo $backURL; ?>
                    <a href="<?php echo base_url(); ?>"><img class="logo" src='<?php echo $path_setting.$setting['setting_logo']; ?>' alt="" width="200" ></a>
                ...
                <div class="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav flex-child-menu menu-left">
                        ...
                        <li class="first">
                            <a href="<?php echo base_url('/category/69/หนังการ์ตูน'); ?>" class="btn btn-default lv1">
                                หนังการ์ตูน
                            </a>
                        </li>
                        <li class="first">
                        ...
                        <li class="first">
                            <a href="<?php echo base_url('/category/65/หนังไทย'); ?>" class="btn btn-default lv1">
                        ...
                        <li class="first">
                            <a href="<?php echo base_url('/category/66/หนังฝรั่ง'); ?>" class="btn btn-default lv1">
                                หนังฝรั่ง
                            </a>
                        </li>
                        <li>
