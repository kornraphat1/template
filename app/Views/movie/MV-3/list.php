   ...
   <link rel="stylesheet" type="text/css" href='<?php echo base_url("/assets/css/ad.css")?>'>
            <div class="col-lg-9 col-md-9">
               ...
               <section id="home-main">
                  ...
                  <h1 class="icon"><i class="fa fa-television" aria-hidden="true"></i><?=$cateRow['category_name']?></h1>
                  <div class="row">
                     <!-- ARTICLES -->
                        ...
                        <div class="row auto-clear">
                              <?php 
                                 ...
                                 if($value['movie_type']=="mo"){
                                    $urlvideo = base_url('/page/video/id/'.$id.'/main/'.urlencode($value['movie_thname']));
                                 }
                                 else if($value['movie_type']=="se"){
                                    $urlvideo = base_url('/series/'.$id.'/main/'.urlencode($value['movie_thname']));
                                 }else{
                                    $urlvideo = base_url('/page/video/id/'.$id.'/main/'.urlencode($value['movie_thname']));
                                 }
                                 //print_r($urlvideo);
