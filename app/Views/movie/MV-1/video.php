<div id="content">
	...
	<div class="content-main">
		...
		<div class="box-header">
                ...
                <ul>
                    ...
                    <li class="menu-item current-menu-item">
                        ...
                        <h2 style="color: #f2d45f;"><?php echo $video_data['movie_name']; ?></h2>
			...
			<div class="movie-header">
				...
				<div class="movie-thumbnail">
					...
					<img src="<?php echo $video_data['movie_picture']; ?>" alt="<?php echo $video_data['movie_name']; ?>" title="<?php echo $video_data['movie_name']; ?>">
					...
					<div class="description align-left">
						...
						<p style="font-size:100%;font-weight: normal;">
							...
							if (!empty($video_data['movie_des'])) {
								...
								echo "<strong>" . $video_data['movie_name'] . "</strong> ";
					...
					<div class="video-info">
						...
						<div class="row">
							...
							<div class="col-lg-3">
								...
								<button class="pull-right btn report-movie" onclick="goReport('<?= $video_data['movie_id'] ?>','<?= $video_data['branch_id'] ?>','<?= $video_data['movie_name'] ?>','<?= $ep_name ?>')">
						...
						<div class="row">
							...
							if(!empty($video_data['name_ep'])){
								if ($index > 0) {
									...
									$url_name =  urldecode(trim(str_replace(")", "", (str_replace("(", "", (str_replace(" ", "-", $video_data['movie_name'])))))));
									$url_name = str_replace("%","%25",$url_name);
									$key = $index - 1;
								...
								<select onchange="click_ep(this)">
									...
									?>
										...
										<option value="<?php echo $url_name . '/' . $key . '/' . $url_epname ?>" <?= $select; ?>><?php echo $video_data['movie_name'] . ' - ' . $value ?> </option>
		...
		<div class="box" style="position: relative;">
			...
			<div class="fb-comments" style="background: #908f8f;" data-href="<?= base_url(uri_string()) ?>" data-colorscheme="dark" data-width="100%" data-numposts="5"></div>
	...
	<script>
	 function click_ep(selectObject) {
		...
		var res = value.replace("%", "%25");
		var url = "<?= base_url() ?>/series/<?= $video_data['movie_id'] ?>/" + res;
		window.location.href = "<?= base_url() ?>/series/<?= $video_data['movie_id'] ?>/" + res;
	}
	</script>