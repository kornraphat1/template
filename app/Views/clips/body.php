        ...
        <div class="box">
            <div class="box-header">
                <ul>
                    <li class="menu-item current-menu-item">
                        <h2 class="text-center">Clips 18+</h2>
                    </li>
                </ul>
            </div>
            <?php
            foreach ($list_video as $value) {
                ...
                if ($value['movie_type'] == 'se') {
                    ...
                    $urlvideo = str_replace('%', '%25', urldecode(base_url('/clips/video/' . $id . '/' . $url_name)));
                }
        ...
        <?php foreach ($video_interest as $value) {  ?>
            <div class="title-hd col-lg-12">
                <div class="box-header">
                    ...
                    <ul style="float:right;">
                        <li class="menu-item current-menu-item">
                            <a class="pull-right" href="<?php echo base_url("/clips/category/" . $value['category_id'] . "/" . urlencode(str_replace(' ', '-', $value['category_name']))); ?>" style="margin-right: 10px;">ดูทั้งหมด...</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            foreach ($value['list'] as $val) {
                ...
                $url_name = urldecode(str_replace([" ", "'"], ["-", ""], $val['movie_thname']));
                    ...
                    $urlvideo = base_url('/clips/video/' . $movie_id . '/' . $url_name);
