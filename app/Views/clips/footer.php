    ...
    <script>
      function goReport(id, branch, name) {
            ...
            if (request != null && request != '') {
                jQuery.ajax({
                    ...
                    url: "<?php echo base_url()?>/clips/savereport/branch/" + branch + "/id/" + id + "/reason/" + request + "/name/" + name,
                    type: 'GET',
                    crossDomain: true,
                    cache: false,
        ...
        function request_movie(branch) {
            ...
            if (movie != null) {
                ...
                jQuery.ajax({
                    ...
                    url: "/clips/saverequest/branch/" + branch + "/movie/" + movie,
        ...
        jQuery("#formsearch").submit(function(event) {
            ...
            if (jQuery("#search").val()) {
                ...
                var url = "<?= base_url('/clips/search') ?>" + '/' + jQuery("#search").val();
        ...
        function countView(id) {
            ...
            var url = base_url + "/clips/countview/" + id;
            // alert(url);
            jQuery.ajax({
