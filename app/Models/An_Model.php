...
class An_Model extends Model
{
    ...
    public function get_anime_data($id)
    {
        $sql = "SELECT
                ...
                FROM
                    `$this->table_movie`
                    LEFT JOIN `$this->mo_moviecate` on `$this->table_movie`.movie_id = `$this->mo_moviecate`.movie_id 
                WHERE
    ...
    //             FROM
    //             `$this->mo_moviecate`
    //             INNER JOIN `$this->table_category`ON `$this->mo_moviecate`category_id = `$this->table_category`.category_id 
    //             WHERE 
