        ...
        case 'MV-4':
            ...
            switch ($view) {
                ...
                case 'index':
                    ...
                    $movie_recomend = $VideoModel->get_movie_new_recommend($parameter['branch'], $parameter['keyword_string'], 24, $parameter['page']);
        ...
        case 'MV-6':
            ...
            switch ($view) {
                ...
                case 'index':
                    ...
                    $top_imdb = $VideoModel->get_list_topimdb($parameter['branch'], 24, $parameter['page']);
                ...
                case 'newmovie':
                    ...
                    $list_video = $VideoModel->get_list_video($parameter['branch'], '', 25, $parameter['page']);
...
function calltemplate_av($template, $view, $parameter = [])

{

    $VideoModel = new AV_Model();
        ...
        case 'AV-2':
            ...
            switch ($view) {
                ...
                case 'index':
                    ...
                    $list_video = $VideoModel->get_list_video($parameter['branch'], $parameter['keyword_string'], 30, $parameter['page']);

                    $category_list = $VideoModel->get_category($parameter['branch'], 'av');

                    $list_video_ranking  = $VideoModel->get_list_video_ranking($parameter['branch'], '',  $parameter['page']);

                    $list_video_popular_ranking = $VideoModel->get_list_video_popular_ranking($parameter['branch'], '', $parameter['page']);

                    $list_movie_recommend = $VideoModel->get_movie_new_recommend($parameter['branch'], '', $parameter['page']);

                    //    echo '<pre>',print_r($video_cate,true),'</pre>';die;
                    ...
                    $list = [
                        ...
                        'new_movie_recom' => $list_movie_recommend,

                        'list_video_ranking' => $list_video_ranking,

                        'list_video_popular_ranking' => $list_video_popular_ranking,
             ...
             case 'video_bycate':
                ...
                case 'video':
                    ...
                    $category_pagevideo = $VideoModel->showcategory_pagevideo($parameter['id']);
